...
gulp.task('build',
  gulp.series(clean, pages, sass, images, inline, renameSsFiles));
...
function inline() {
  return gulp.src('dist/**/*.html')
    ...
    .pipe(gulp.dest('dist'))
    .pipe(gulp.dest('../president-holiday-card/mysite/templates'))
    ;
}


function renameSsFiles(){
  return gulp.src("../president-holiday-card/mysite/templates/**.html")
...
function watch() {
  gulp.watch('src/pages/**/*.html').on('all', gulp.series(pages, inline,renameSsFiles, browser.reload));
  gulp.watch(['src/layouts/**/*', 'src/partials/**/*']).on('all', gulp.series(resetPages, pages, inline, renameSsFiles, browser.reload));
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss']).on('all', gulp.series(resetPages, sass, pages, inline, renameSsFiles, browser.reload));
